...
void write_5_DIR(Xuint32 col,Xuint32 dir){
	for(i = 0; i < 7; i++)
		BANNER_enviarcondireccion(col,i,cinco[i],dir);}

void write_6_DIR(Xuint32 col,Xuint32 dir){
	for(i = 0; i < 7; i++)
		BANNER_enviarcondireccion(col,i,seis[i],dir);}

void write_7_DIR(Xuint32 col,Xuint32 dir){
	for(i = 0; i < 7; i++)
		BANNER_enviarcondireccion(col,i,siete[i],dir);}

void write_8_DIR(Xuint32 col,Xuint32 dir){
	for(i = 0; i < 7; i++)
		BANNER_enviarcondireccion(col,i,ocho[i],dir);}

void write_9_DIR(Xuint32 col,Xuint32 dir){
	for(i = 0; i < 7; i++)
		BANNER_enviarcondireccion(col,i,nueve[i],dir);}
...
void write_smile_DIR(Xuint32 col,Xuint32 dir){
	for(i = 0; i < 7; i++)
		BANNER_enviarcondireccion(col,i,smile[i],dir);}
