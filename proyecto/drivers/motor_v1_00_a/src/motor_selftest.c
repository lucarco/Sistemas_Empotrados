/*****************************************************************************
* Filename:          D:\hlocal\SE\Practicas\proyecto/drivers/motor_v1_00_a/src/motor_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the motor driver
...
XStatus MOTOR_SelfTest(void * baseaddr_p)
{
  ...
  MOTOR_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = MOTOR_mReadSlaveReg0(baseaddr, 0);
