/*****************************************************************************
* Filename:          D:\hlocal\SE\Practicas\proyecto/drivers/led_rgb_v1_00_a/src/led_rgb_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the led_rgb driver
...
XStatus LED_RGB_SelfTest(void * baseaddr_p)
{
  ...
  LED_RGB_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = LED_RGB_mReadSlaveReg0(baseaddr, 0);
  ...
  LED_RGB_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = LED_RGB_mReadSlaveReg1(baseaddr, 0);
  ...
  LED_RGB_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = LED_RGB_mReadSlaveReg2(baseaddr, 0);
