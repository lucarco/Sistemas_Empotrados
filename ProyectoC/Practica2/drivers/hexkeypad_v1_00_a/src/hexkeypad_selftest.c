/*****************************************************************************
* Filename:          C:\hlocal\SE\Proyecto\Practica2/drivers/hexkeypad_v1_00_a/src/hexkeypad_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the hexkeypad driver
...
XStatus HEXKEYPAD_SelfTest(void * baseaddr_p)
{
  ...
  HEXKEYPAD_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = HEXKEYPAD_mReadSlaveReg0(baseaddr, 0);
