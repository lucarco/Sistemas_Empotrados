...
architecture STRUCTURE of system is
  ...
  component system_switches_wrapper is
    port (
      SPLB_Clk : in std_logic;
      SPLB_Rst : in std_logic;
      PLB_ABus : in std_logic_vector(0 to 31);
  ...
  component system_infrarrojos_0_wrapper is
    port (
      SPLB_Clk : in std_logic;
      SPLB_Rst : in std_logic;
      PLB_ABus : in std_logic_vector(0 to 31);
      ...
      Sl_MRdErr : out std_logic_vector(0 to 1);
      Sl_MIRQ : out std_logic_vector(0 to 1);
      code_infraredTop : out std_logic
    );
  end component;

  component system_hexkeypad_0_wrapper is
    port (
      SPLB_Clk : in std_logic;
      SPLB_Rst : in std_logic;
      PLB_ABus : in std_logic_vector(0 to 31);
  ...
  component system_matriz_de_puntos_0_wrapper is
    port (
      SPLB_Clk : in std_logic;
      SPLB_Rst : in std_logic;
      PLB_ABus : in std_logic_vector(0 to 31);
  ...
  component system_leds_rgb_0_wrapper is
    port (
      ...
      Sl_MRdErr : out std_logic_vector(0 to 1);
      Sl_MIRQ : out std_logic_vector(0 to 1);
      redTop : out std_logic;
      greenTop : out std_logic;
      blueTop : out std_logic
    );
  end component;
  ...
  signal hexkeypad_0_R : std_logic_vector(3 downto 0);
  signal hexkeypad_0_S : std_logic_vector(3 downto 0);
  signal infrarrojos_0_code_infraredTop : std_logic;
  ...
  signal matriz_de_puntos_0_col_clk : std_logic;
  signal matriz_de_puntos_0_col_serial_out : std_logic;
  signal matriz_de_puntos_0_reset2_out : std_logic;
  signal matriz_de_puntos_0_reset_out : std_logic;
  signal matriz_de_puntos_0_row_clk : std_logic;
  signal matriz_de_puntos_0_row_serial_out : std_logic;
  ...
  attribute BOX_TYPE of system_switches_wrapper : component is "user_black_box";
  ...
  attribute BOX_TYPE of system_infrarrojos_0_wrapper : component is "user_black_box";
  attribute BOX_TYPE of system_hexkeypad_0_wrapper : component is "user_black_box";
  attribute BOX_TYPE of system_bram_block_0_wrapper : component is "user_black_box";
  attribute BOX_TYPE of system_matriz_de_puntos_0_wrapper : component is "user_black_box";
...
begin
  ...
  net_plb_v46_0_SYS_Rst_pin <= plb_v46_0_SYS_Rst_pin;
  infrarrojos_0_code_infraredTop_pin <= infrarrojos_0_code_infraredTop;
  hexkeypad_0_S_pin <= hexkeypad_0_S;
  hexkeypad_0_R <= hexkeypad_0_R_pin;
  matriz_de_puntos_0_col_serial_out_pin <= matriz_de_puntos_0_col_serial_out;
  matriz_de_puntos_0_col_clk_pin <= matriz_de_puntos_0_col_clk;
  matriz_de_puntos_0_row_serial_out_pin <= matriz_de_puntos_0_row_serial_out;
  matriz_de_puntos_0_row_clk_pin <= matriz_de_puntos_0_row_clk;
  matriz_de_puntos_0_reset_out_pin <= matriz_de_puntos_0_reset_out;
  matriz_de_puntos_0_reset2_out_pin <= matriz_de_puntos_0_reset2_out;
  ...
  switches : system_switches_wrapper
    port map (
      SPLB_Clk => plb_v46_0_PLB_Clk,
  ...
  infrarrojos_0 : system_infrarrojos_0_wrapper
    port map (
      SPLB_Clk => plb_v46_0_PLB_Clk,
      ...
      code_infraredTop => infrarrojos_0_code_infraredTop
    );

  hexkeypad_0 : system_hexkeypad_0_wrapper
    port map (
      SPLB_Clk => plb_v46_0_PLB_Clk,
  ...
  matriz_de_puntos_0 : system_matriz_de_puntos_0_wrapper
    port map (
      SPLB_Clk => plb_v46_0_PLB_Clk,
      ...
      col_serial_out => matriz_de_puntos_0_col_serial_out,
      col_clk => matriz_de_puntos_0_col_clk,
      row_serial_out => matriz_de_puntos_0_row_serial_out,
      row_clk => matriz_de_puntos_0_row_clk,
      reset_out => matriz_de_puntos_0_reset_out,
      reset2_out => matriz_de_puntos_0_reset2_out
    );
  ...
  leds_rgb_0 : system_leds_rgb_0_wrapper
    port map (
      ...
      redTop => leds_rgb_0_red,
      greenTop => leds_rgb_0_green,
      blueTop => leds_rgb_0_blue
    );
