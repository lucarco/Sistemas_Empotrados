...
Peripheral Summary:
  ...
  logical library name                       : infrarrojos_v1_00_a
  top name                                   : infrarrojos
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
- XST synthesis file(s)
  ...
  devl/synthesis/infrarrojos_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/infrarrojos_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/infrarrojos_v2_1_0.tcl
