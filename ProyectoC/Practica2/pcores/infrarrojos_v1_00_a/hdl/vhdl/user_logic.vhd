...
-- Date:              Fri Nov 29 08:04:09 2013 (by Create and Import Peripheral Wizard)
...
architecture IMP of user_logic is
 ...
 SIGNAL cuenta1, cuenta2: std_logic_vector(27 downto 0);
 ...
 -- Divisor de frecuencias que obtiene en clk_aux1 una señal de reloj de 38 KHz (frecuencia portadora)
  ...
  BEGIN
    ...
    ELSIF(Bus2IP_Clk'EVENT AND Bus2IP_Clk='1') THEN
		IF(cuenta1="0000000000000000001010010001") THEN -- 100 MHz / 38 KHz / 2 = 1315
 ...
 -- Divisor de frecuencias que obtiene en clk_aux2 una señal de reloj de 1 Hz (frecuencia de la señal)
  ...
  BEGIN
    IF (Bus2IP_Reset='1') THEN
      cuenta2<= (OTHERS=>'0');
    ELSIF(Bus2IP_Clk'EVENT AND Bus2IP_Clk='1') THEN
      IF (cuenta2 = "0010111110101111000010000000") THEN  -- 1 Hz
