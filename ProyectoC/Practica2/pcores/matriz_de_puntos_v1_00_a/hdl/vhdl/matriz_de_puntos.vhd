------------------------------------------------------------------------------
-- matriz_de_puntos.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          matriz_de_puntos.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Thu Feb 25 02:44:53 2021 (by Create and Import Peripheral Wizard)
...
library matriz_de_puntos_v1_00_a;
use matriz_de_puntos_v1_00_a.user_logic;
...
end entity matriz_de_puntos;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of matriz_de_puntos is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity matriz_de_puntos_v1_00_a.user_logic
    generic map
    (
