/*****************************************************************************
* Filename:          C:\hlocal\SE\Proyecto\Practica2/drivers/infrarrojos_v1_00_a/src/infrarrojos_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the infrarrojos driver
...
XStatus INFRARROJOS_SelfTest(void * baseaddr_p)
{
  ...
  INFRARROJOS_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = INFRARROJOS_mReadSlaveReg0(baseaddr, 0);
