------------------------------------------------------------------------------
-- banner_pantalla.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          banner_pantalla.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Fri Feb 19 19:44:15 2021 (by Create and Import Peripheral Wizard)
...
use banner_pantalla_v1_00_a.user_logic;
...
end entity banner_pantalla;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of banner_pantalla is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity banner_pantalla_v1_00_a.user_logic
    generic map
    (
